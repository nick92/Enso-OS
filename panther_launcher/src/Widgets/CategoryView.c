...
static void __lambda48_ (PantherWidgetsCategoryView* self, const gchar* name, gint nth);
...
static void ___lambda48__panther_widgets_sidebar_selection_changed (PantherWidgetsSidebar* _sender, const gchar* entry_name, gint nth, gpointer self);
...
static void __lambda49_ (PantherWidgetsCategoryView* self);
static void ___lambda49__panther_widgets_app_entry_app_launched (PantherWidgetsAppEntry* _sender, gpointer self);
...
PantherWidgetsCategoryView* panther_widgets_category_view_construct (GType object_type, PantherPantherView* parent) {
	...
	PantherWidgetsSidebar* _tmp17_ = NULL;
...
void panther_widgets_category_view_setup_sidebar (PantherWidgetsCategoryView* self) {
	...
	gint _tmp7_ = 0;
	gint _tmp8_ = 0;
	PantherWidgetsSidebar* _tmp9_ = NULL;
	const gchar* _tmp10_ = NULL;
	gchar* _tmp11_ = NULL;
	gchar* _tmp12_ = NULL;
	PantherWidgetsSidebar* _tmp34_ = NULL;
	...
	gint _tmp40_ = 0;
	gint columns = 0;
	PantherPantherView* _tmp42_ = NULL;
	gint _tmp43_ = 0;
	gint _tmp44_ = 0;
	gint _tmp45_ = 0;
	PantherWidgetsGrid* _tmp46_ = NULL;
	PantherPantherView* _tmp47_ = NULL;
	gint _tmp48_ = 0;
	gint _tmp49_ = 0;
	PantherWidgetsSidebar* _tmp50_ = NULL;
	gint _tmp51_ = 0;
	...
	_tmp7_ = n;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp6_, (gpointer) ((gintptr) _tmp7_), "All");
	_tmp8_ = n;
	n = _tmp8_ + 1;
	_tmp9_ = self->category_switcher;
	_tmp10_ = g_dgettext ("gnome-menus-3.0", "All");
	_tmp11_ = g_strdup (_tmp10_);
	_tmp12_ = _tmp11_;
	panther_widgets_sidebar_add_category (_tmp9_, _tmp12_);
	_g_free0 (_tmp12_);
	{
		...
		while (TRUE) {
			...
			PantherWidgetsSidebar* _tmp28_ = NULL;
			const gchar* _tmp29_ = NULL;
			const gchar* _tmp30_ = NULL;
			gchar* _tmp31_ = NULL;
			gchar* _tmp32_ = NULL;
			gint _tmp33_ = 0;
			_tmp20_ = _cat_name_it;
			_tmp21_ = gee_iterator_next (_tmp20_);
			if (!_tmp21_) {
				break;
			}
			_tmp22_ = _cat_name_it;
			_tmp23_ = gee_iterator_get (_tmp22_);
			cat_name = (gchar*) _tmp23_;
			_tmp24_ = cat_name;
			if (g_strcmp0 (_tmp24_, PANTHER_WIDGETS_CATEGORY_VIEW_SWITCHBOARD_CATEGORY) == 0) {
				_g_free0 (cat_name);
				continue;
			}
			_tmp25_ = self->category_ids;
			_tmp26_ = n;
			_tmp27_ = cat_name;
			gee_abstract_map_set ((GeeAbstractMap*) _tmp25_, (gpointer) ((gintptr) _tmp26_), _tmp27_);
			_tmp28_ = self->category_switcher;
			_tmp29_ = cat_name;
			_tmp30_ = g_dgettext ("gnome-menus-3.0", _tmp29_);
			_tmp31_ = g_strdup (_tmp30_);
			_tmp32_ = _tmp31_;
			panther_widgets_sidebar_add_category (_tmp28_, _tmp32_);
			_g_free0 (_tmp32_);
			_tmp33_ = n;
			n = _tmp33_ + 1;
			_g_free0 (cat_name);
	...
	_tmp37_ = minimum_width;
	_tmp38_ = panther_pixels_ITEM_SIZE;
	removing_columns = (gint) (((gdouble) _tmp37_) / ((gdouble) _tmp38_));
	_tmp39_ = minimum_width;
	_tmp40_ = panther_pixels_ITEM_SIZE;
	if ((_tmp39_ % _tmp40_) != 0) {
		gint _tmp41_ = 0;
		_tmp41_ = removing_columns;
		removing_columns = _tmp41_ + 1;
	}
	_tmp42_ = self->priv->view;
	_tmp43_ = panther_panther_view_get_columns (_tmp42_);
	_tmp44_ = _tmp43_;
	_tmp45_ = removing_columns;
	columns = _tmp44_ - _tmp45_;
	_tmp46_ = self->app_view;
	_tmp47_ = self->priv->view;
	_tmp48_ = panther_panther_view_get_rows (_tmp47_);
	_tmp49_ = _tmp48_;
	panther_widgets_grid_resize (_tmp46_, _tmp49_, columns);
	_tmp50_ = self->category_switcher;
	_tmp51_ = old_selected;
	panther_widgets_sidebar_set_selected (_tmp50_, _tmp51_);
}
...
static void __lambda48_ (PantherWidgetsCategoryView* self, const gchar* name, gint nth) {
	...
	panther_widgets_category_view_show_filtered_apps (self, category);
	_g_free0 (category);
}


static void ___lambda48__panther_widgets_sidebar_selection_changed (PantherWidgetsSidebar* _sender, const gchar* entry_name, gint nth, gpointer self) {
	__lambda48_ ((PantherWidgetsCategoryView*) self, entry_name, nth);
}
...
static void panther_widgets_category_view_connect_events (PantherWidgetsCategoryView* self) {
	...
	g_return_if_fail (self != NULL);
	_tmp0_ = self->category_switcher;
	g_signal_connect_object (_tmp0_, "selection-changed", (GCallback) ___lambda48__panther_widgets_sidebar_selection_changed, self, 0);
}
...
static void ___lambda49__panther_widgets_app_entry_app_launched (PantherWidgetsAppEntry* _sender, gpointer self) {
	__lambda49_ ((PantherWidgetsCategoryView*) self);
}
...
static void panther_widgets_category_view_add_app (PantherWidgetsCategoryView* self, PantherBackendApp* app) {
	...
	app_entry = _tmp1_;
	g_signal_connect_object (app_entry, "app-launched", (GCallback) ___lambda49__panther_widgets_app_entry_app_launched, self, 0);
	...
	if (g_strcmp0 (_tmp1_, "All") != 0) {
		{
			...
			while (TRUE) {
				...
				app = (PantherBackendApp*) _tmp14_;
				_tmp15_ = app;
				panther_widgets_category_view_add_app (self, _tmp15_);
				_g_object_unref0 (app);
			}
			_g_object_unref0 (_app_list);
		}
	} else {
		PantherPantherView* _tmp16_ = NULL;
		GSList* _tmp17_ = NULL;
		_tmp16_ = self->priv->view;
		_tmp17_ = _tmp16_->app_name;
		{
			...
			for (app_it = app_collection; app_it != NULL; app_it = app_it->next) {
				...
				PantherBackendApp* app = NULL;
				_tmp18_ = _g_object_ref0 ((PantherBackendApp*) app_it->data);
				app = _tmp18_;
				{
