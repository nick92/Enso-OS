...
static void ___lambda40_ (PantherWidgetsSearchItem* self, GObject* obj, GAsyncResult* res);
static void ____lambda40__gasync_ready_callback (GObject* source_object, GAsyncResult* res, gpointer self);
...
static void ___lambda41_ (Block6Data* _data6_, GdkDragContext* ctx);
GdkPixbuf* panther_backend_app_get_icon (PantherBackendApp* self);
static void ____lambda41__gtk_widget_drag_begin (GtkWidget* _sender, GdkDragContext* context, gpointer self);
static void ___lambda42_ (PantherWidgetsSearchItem* self);
static void ____lambda42__gtk_widget_drag_end (GtkWidget* _sender, GdkDragContext* context, gpointer self);
static void ___lambda43_ (Block6Data* _data6_, GdkDragContext* ctx, GtkSelectionData* sel, guint info, guint time);
const gchar* synapse_application_match_get_filename (SynapseApplicationMatch* self);
static void ____lambda43__gtk_widget_drag_data_get (GtkWidget* _sender, GdkDragContext* context, GtkSelectionData* selection_data, guint info, guint time_, gpointer self);
...
static void ____lambda40__gasync_ready_callback (GObject* source_object, GAsyncResult* res, gpointer self) {
	___lambda40_ ((PantherWidgetsSearchItem*) self, source_object, res);
	g_object_unref (self);
}
...
static void ____lambda42__gtk_widget_drag_end (GtkWidget* _sender, GdkDragContext* context, gpointer self) {
	___lambda42_ ((PantherWidgetsSearchItem*) self);
}
...
PantherWidgetsSearchItem* panther_widgets_search_item_construct (GType object_type, PantherBackendApp* app, const gchar* search_term, gboolean action, const gchar* action_title) {
	...
	if (_tmp26_) {
		...
		panther_backend_synapse_search_get_favicon_for_match (_tmp33_, PANTHER_WIDGETS_SEARCH_ITEM_ICON_SIZE, _tmp34_, ____lambda40__gasync_ready_callback, g_object_ref (self));
	}
