...
static gboolean __lambda43_ (Block7Data* _data7_, GdkEventKey* e);
static gboolean ___lambda43__gtk_widget_key_press_event (GtkWidget* _sender, GdkEventKey* event, gpointer self);
...
static void __lambda47_ (PantherWidgetsSearchView* self, SynapseSearchMatch* search, SynapseMatch* target);
static void ___lambda47__panther_backend_app_start_search (PantherBackendApp* _sender, SynapseSearchMatch* search_match, SynapseMatch* target, gpointer self);
static gboolean __lambda48_ (Block8Data* _data8_);
gboolean panther_backend_app_launch (PantherBackendApp* self);
static gboolean ___lambda48__gtk_widget_button_release_event (GtkWidget* _sender, GdkEventButton* event, gpointer self);
...
static void __lambda45_ (PantherWidgetsSearchView* self, SynapseSearchMatch* search, SynapseMatch* target);
static void ___lambda45__panther_backend_app_start_search (PantherBackendApp* _sender, SynapseSearchMatch* search_match, SynapseMatch* target, gpointer self);
static gboolean __lambda46_ (Block9Data* _data9_);
void synapse_match_execute (SynapseMatch* self, SynapseMatch* match);
static gboolean ___lambda46__gtk_widget_button_release_event (GtkWidget* _sender, GdkEventButton* event, gpointer self);
...
static void _____lambda44_ (PantherWidgetsSearchView* self, SynapseSearchMatch* search, SynapseMatch* target);
static void ______lambda44__panther_backend_app_start_search (PantherBackendApp* _sender, SynapseSearchMatch* search_match, SynapseMatch* target, gpointer self);
...
PantherWidgetsSearchView* panther_widgets_search_view_construct (GType object_type, PantherPantherView* parent) {
	...
	g_signal_connect_data ((GtkWidget*) _tmp16_, "key-press-event", (GCallback) ___lambda43__gtk_widget_key_press_event, block7_data_ref (_data7_), (GClosureNotify) block7_data_unref, 0);
...
static void ___lambda47__panther_backend_app_start_search (PantherBackendApp* _sender, SynapseSearchMatch* search_match, SynapseMatch* target, gpointer self) {
	__lambda47_ ((PantherWidgetsSearchView*) self, search_match, target);
}
...
static void panther_widgets_search_view_show_app (PantherWidgetsSearchView* self, PantherBackendApp* app, const gchar* search_term) {
	...
	_tmp5_ = _data8_->app;
	g_signal_connect_object (_tmp5_, "start-search", (GCallback) ___lambda47__panther_backend_app_start_search, self, 0);
	g_signal_connect_data ((GtkWidget*) _data8_->search_item, "button-release-event", (GCallback) ___lambda48__gtk_widget_button_release_event, block8_data_ref (_data8_), (GClosureNotify) block8_data_unref, 0);
	_tmp6_ = self->priv->main_box;
...
static void ___lambda45__panther_backend_app_start_search (PantherBackendApp* _sender, SynapseSearchMatch* search_match, SynapseMatch* target, gpointer self) {
	__lambda45_ ((PantherWidgetsSearchView*) self, search_match, target);
}
...
static void panther_widgets_search_view_show_action (PantherWidgetsSearchView* self, PantherBackendApp* app) {
	...
	_tmp9_ = _data9_->app;
	g_signal_connect_object (_tmp9_, "start-search", (GCallback) ___lambda45__panther_backend_app_start_search, self, 0);
	g_signal_connect_data ((GtkWidget*) _data9_->search_item, "button-release-event", (GCallback) ___lambda46__gtk_widget_button_release_event, block9_data_ref (_data9_), (GClosureNotify) block9_data_unref, 0);
...
static void ______lambda44__panther_backend_app_start_search (PantherBackendApp* _sender, SynapseSearchMatch* search_match, SynapseMatch* target, gpointer self) {
	_____lambda44_ ((PantherWidgetsSearchView*) self, search_match, target);
}
	...
	if (_tmp4_) {
		...
		actions = _tmp23_;
		{
			...
			while (TRUE) {
				...
				app = _tmp41_;
				_tmp42_ = app;
				g_signal_connect_object (_tmp42_, "start-search", (GCallback) ______lambda44__panther_backend_app_start_search, self, 0);
