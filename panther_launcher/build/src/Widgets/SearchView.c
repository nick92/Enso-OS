...
static gboolean __lambda44_ (Block7Data* _data7_, GdkEventKey* e);
static gboolean ___lambda44__gtk_widget_key_press_event (GtkWidget* _sender, GdkEventKey* event, gpointer self);
...
static void __lambda48_ (PantherWidgetsSearchView* self, SynapseSearchMatch* search, SynapseMatch* target);
static void ___lambda48__panther_backend_app_start_search (PantherBackendApp* _sender, SynapseSearchMatch* search_match, SynapseMatch* target, gpointer self);
static gboolean __lambda49_ (Block8Data* _data8_);
gboolean panther_backend_app_launch (PantherBackendApp* self);
static gboolean ___lambda49__gtk_widget_button_release_event (GtkWidget* _sender, GdkEventButton* event, gpointer self);
...
static void _____lambda45_ (PantherWidgetsSearchView* self, SynapseSearchMatch* search, SynapseMatch* target);
static void ______lambda45__panther_backend_app_start_search (PantherBackendApp* _sender, SynapseSearchMatch* search_match, SynapseMatch* target, gpointer self);
...
PantherWidgetsSearchView* panther_widgets_search_view_construct (GType object_type, PantherPantherView* parent) {
	...
	g_signal_connect_data ((GtkWidget*) _tmp16_, "key-press-event", (GCallback) ___lambda44__gtk_widget_key_press_event, block7_data_ref (_data7_), (GClosureNotify) block7_data_unref, 0);
...
static void ___lambda48__panther_backend_app_start_search (PantherBackendApp* _sender, SynapseSearchMatch* search_match, SynapseMatch* target, gpointer self) {
	__lambda48_ ((PantherWidgetsSearchView*) self, search_match, target);
}
...
static void panther_widgets_search_view_show_app (PantherWidgetsSearchView* self, PantherBackendApp* app, const gchar* search_term) {
	...
	_tmp5_ = _data8_->app;
	g_signal_connect_object (_tmp5_, "start-search", (GCallback) ___lambda48__panther_backend_app_start_search, self, 0);
...
static void panther_widgets_search_view_show_action (PantherWidgetsSearchView* self, PantherBackendApp* app) {
	...
	_tmp9_ = _data9_->app;
	g_signal_connect_object (_tmp9_, "start-search", (GCallback) ___lambda46__panther_backend_app_start_search, self, 0);
...
static void ______lambda45__panther_backend_app_start_search (PantherBackendApp* _sender, SynapseSearchMatch* search_match, SynapseMatch* target, gpointer self) {
	_____lambda45_ ((PantherWidgetsSearchView*) self, search_match, target);
}
	...
	if (_tmp4_) {
		...
		actions = _tmp23_;
		{
			...
			while (TRUE) {
				...
				app = _tmp41_;
				_tmp42_ = app;
				g_signal_connect_object (_tmp42_, "start-search", (GCallback) ______lambda45__panther_backend_app_start_search, self, 0);
