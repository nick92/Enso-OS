...
static void __lambda29_ (PantherWidgetsAppEntry* self, GdkDragContext* ctx);
static void ___lambda29__gtk_widget_drag_begin (GtkWidget* _sender, GdkDragContext* context, gpointer self);
static void __lambda30_ (PantherWidgetsAppEntry* self);
...
static void __lambda31_ (PantherWidgetsAppEntry* self, GdkDragContext* ctx, GtkSelectionData* sel, guint info, guint time);
...
static void ___lambda32__panther_backend_app_icon_changed (PantherBackendApp* _sender, gpointer self);
...
static void ___lambda29__gtk_widget_drag_begin (GtkWidget* _sender, GdkDragContext* context, gpointer self) {
	__lambda29_ ((PantherWidgetsAppEntry*) self, context);
}
...
static void ___lambda30__gtk_widget_drag_end (GtkWidget* _sender, GdkDragContext* context, gpointer self) {
	__lambda30_ ((PantherWidgetsAppEntry*) self);
}
...
static void ___lambda31__gtk_widget_drag_data_get (GtkWidget* _sender, GdkDragContext* context, GtkSelectionData* selection_data, guint info, guint time_, gpointer self) {
	__lambda31_ ((PantherWidgetsAppEntry*) self, context, selection_data, info, time_);
}
...
PantherWidgetsAppEntry* panther_widgets_app_entry_construct (GType object_type, PantherBackendApp* app) {
	...
	_tmp72_ = _data4_->app;
	g_signal_connect_data (_tmp72_, "icon-changed", (GCallback) ___lambda32__panther_backend_app_icon_changed, block4_data_ref (_data4_), (GClosureNotify) block4_data_unref, 0);
