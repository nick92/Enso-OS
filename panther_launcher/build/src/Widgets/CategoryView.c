...
static void __lambda27_ (PantherWidgetsCategoryView* self, const gchar* name, gint nth);
...
static void ___lambda27__panther_widgets_sidebar_selection_changed (PantherWidgetsSidebar* _sender, const gchar* entry_name, gint nth, gpointer self);
...
static void __lambda28_ (PantherWidgetsCategoryView* self);
static void ___lambda28__panther_widgets_app_entry_app_launched (PantherWidgetsAppEntry* _sender, gpointer self);
...
static void ___lambda27__panther_widgets_sidebar_selection_changed (PantherWidgetsSidebar* _sender, const gchar* entry_name, gint nth, gpointer self) {
	__lambda27_ ((PantherWidgetsCategoryView*) self, entry_name, nth);
}
...
static void panther_widgets_category_view_connect_events (PantherWidgetsCategoryView* self) {
	...
	g_return_if_fail (self != NULL);
	_tmp0_ = self->category_switcher;
	g_signal_connect_object (_tmp0_, "selection-changed", (GCallback) ___lambda27__panther_widgets_sidebar_selection_changed, self, 0);
}
...
static void ___lambda28__panther_widgets_app_entry_app_launched (PantherWidgetsAppEntry* _sender, gpointer self) {
	__lambda28_ ((PantherWidgetsCategoryView*) self);
}
...
static void panther_widgets_category_view_add_app (PantherWidgetsCategoryView* self, PantherBackendApp* app) {
	...
	app_entry = _tmp1_;
	g_signal_connect_object (app_entry, "app-launched", (GCallback) ___lambda28__panther_widgets_app_entry_app_launched, self, 0);
