...
static gint __lambda8_ (GeeMapEntry* a, GeeMapEntry* b);
static gint ___lambda8__gcompare_data_func (gconstpointer a, gconstpointer b, gpointer self);
...
static gint ___lambda8__gcompare_data_func (gconstpointer a, gconstpointer b, gpointer self) {
	gint result;
	result = __lambda8_ ((GeeMapEntry*) a, (GeeMapEntry*) b);
	return result;
}
...
GeeList* synapse_query_get_matchers_for_query (const gchar* query, SynapseMatcherFlags match_flags, GRegexCompileFlags flags) {
	...
	gee_list_sort ((GeeList*) sorted_results, ___lambda8__gcompare_data_func, NULL, NULL);
