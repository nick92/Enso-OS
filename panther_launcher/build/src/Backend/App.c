...
static void __lambda33_ (PantherBackendApp* self);
static gboolean ___lambda34_ (PantherBackendApp* self);
...
static gboolean ____lambda34__gsource_func (gpointer self) {
	gboolean result;
	result = ___lambda34_ ((PantherBackendApp*) self);
	return result;
}
...
static void __lambda33_ (PantherBackendApp* self) {
	...
	if (_tmp0_) {
		...
		g_timeout_add_seconds_full (G_PRIORITY_DEFAULT, (guint) PANTHER_BACKEND_APP_RECHECK_TIMEOUT, ____lambda34__gsource_func, g_object_ref (self), g_object_unref);
	}
}


static void ___lambda33__panther_backend_app_icon_load_fallback (gpointer self) {
	__lambda33_ ((PantherBackendApp*) self);
}
...
GdkPixbuf* panther_backend_app_load_icon (PantherBackendApp* self, gint size) {
	...
	_tmp41_ = panther_backend_app_icon_load_fallback_method_new (___lambda32__panther_backend_app_icon_load_fallback, _data1_);
	_tmp42_ = panther_backend_app_icon_load_fallback_method_new (___lambda33__panther_backend_app_icon_load_fallback, self);
	_tmp43_ = panther_backend_app_icon_load_fallback_method_new (___lambda35__panther_backend_app_icon_load_fallback, _data1_);
	_tmp44_ = panther_backend_app_icon_load_fallback_method_new (___lambda36__panther_backend_app_icon_load_fallback, _data1_);
	_tmp45_ = panther_backend_app_icon_load_fallback_method_new (___lambda37__panther_backend_app_icon_load_fallback, _data1_);
	_tmp46_ = panther_backend_app_icon_load_fallback_method_new (___lambda38__panther_backend_app_icon_load_fallback, _data1_);
