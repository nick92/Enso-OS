...
static void ___lambda33__panther_backend_app_icon_load_fallback (gpointer self);
...
static void __lambda34_ (PantherBackendApp* self);
static gboolean ___lambda35_ (PantherBackendApp* self);
...
static void ___lambda38__panther_backend_app_icon_load_fallback (gpointer self);
static void __lambda39_ (Block1Data* _data1_);
static void ___lambda39__panther_backend_app_icon_load_fallback (gpointer self);
...
static gboolean ____lambda35__gsource_func (gpointer self) {
	gboolean result;
	result = ___lambda35_ ((PantherBackendApp*) self);
	return result;
}
...
static void __lambda34_ (PantherBackendApp* self) {
	...
	if (_tmp0_) {
		...
		g_timeout_add_seconds_full (G_PRIORITY_DEFAULT, (guint) PANTHER_BACKEND_APP_RECHECK_TIMEOUT, ____lambda35__gsource_func, g_object_ref (self), g_object_unref);
	}
}


static void ___lambda34__panther_backend_app_icon_load_fallback (gpointer self) {
	__lambda34_ ((PantherBackendApp*) self);
}
...
GdkPixbuf* panther_backend_app_load_icon (PantherBackendApp* self, gint size) {
	...
	_tmp41_ = panther_backend_app_icon_load_fallback_method_new (___lambda33__panther_backend_app_icon_load_fallback, _data1_);
	_tmp42_ = panther_backend_app_icon_load_fallback_method_new (___lambda34__panther_backend_app_icon_load_fallback, self);
	_tmp43_ = panther_backend_app_icon_load_fallback_method_new (___lambda36__panther_backend_app_icon_load_fallback, _data1_);
	_tmp44_ = panther_backend_app_icon_load_fallback_method_new (___lambda37__panther_backend_app_icon_load_fallback, _data1_);
	_tmp45_ = panther_backend_app_icon_load_fallback_method_new (___lambda38__panther_backend_app_icon_load_fallback, _data1_);
	_tmp46_ = panther_backend_app_icon_load_fallback_method_new (___lambda39__panther_backend_app_icon_load_fallback, _data1_);
