...
guint service_register_object (void* object, GDBusConnection* connection, const gchar* path, GError** error);
...
static void __lambda66_ (Block2Data* _data2_, GDBusConnection* conn);
...
static void ___lambda66__gbus_acquired_callback (GDBusConnection* connection, const gchar* name, gpointer self);
...
static void __lambda67_ (PantherDBusService* self);
static void ___lambda67__gbus_name_lost_callback (GDBusConnection* connection, const gchar* name, gpointer self);
Service* service_new (GtkWindow* view);
Service* service_construct (GType object_type, GtkWindow* view);
...
static void _service_on_view_visibility_change_gtk_widget_show (GtkWidget* _sender, gpointer self);
static void _service_on_view_visibility_change_gtk_widget_hide (GtkWidget* _sender, gpointer self);
static void service_finalize (GObject* obj);
static void service_dbus_interface_method_call (GDBusConnection* connection, const gchar* sender, const gchar* object_path, const gchar* interface_name, const gchar* method_name, GVariant* parameters, GDBusMethodInvocation* invocation, gpointer user_data);
static GVariant* service_dbus_interface_get_property (GDBusConnection* connection, const gchar* sender, const gchar* object_path, const gchar* interface_name, const gchar* property_name, GError** error, gpointer user_data);
static gboolean service_dbus_interface_set_property (GDBusConnection* connection, const gchar* sender, const gchar* object_path, const gchar* interface_name, const gchar* property_name, GVariant* value, GError** error, gpointer user_data);
static void _dbus_service_visibility_changed (GObject* _sender, gboolean launcher_visible, gpointer* _data);
...
static const GDBusArgInfo _service_dbus_arg_info_visibility_changed_launcher_visible = {-1, "launcher_visible", "b"};
...
static const GDBusSignalInfo _service_dbus_signal_info_visibility_changed = {-1, "VisibilityChanged", (GDBusArgInfo **) (&_service_dbus_arg_info_visibility_changed)};
...
static const GDBusInterfaceInfo _service_dbus_interface_info = {-1, "com.rastersoft.panther", (GDBusMethodInfo **) (&_service_dbus_method_info), (GDBusSignalInfo **) (&_service_dbus_signal_info), (GDBusPropertyInfo **) (&_service_dbus_property_info)};
...
static void ___lambda67__gbus_name_lost_callback (GDBusConnection* connection, const gchar* name, gpointer self) {
	__lambda67_ ((PantherDBusService*) self);
}
...
PantherDBusService* panther_dbus_service_construct (GType object_type, PantherPantherView* view) {
	...
	g_bus_own_name_with_closures (G_BUS_TYPE_SESSION, "com.rastersoft.panther", G_BUS_NAME_OWNER_FLAGS_NONE, (GClosure*) ((___lambda66__gbus_acquired_callback == NULL) ? NULL : g_cclosure_new ((GCallback) ___lambda66__gbus_acquired_callback, block2_data_ref (_data2_), block2_data_unref)), (GClosure*) ((_panther_dbus_service_name_acquired_handler_gbus_name_acquired_callback == NULL) ? NULL : g_cclosure_new ((GCallback) _panther_dbus_service_name_acquired_handler_gbus_name_acquired_callback, g_object_ref (self), g_object_unref)), (GClosure*) ((___lambda67__gbus_name_lost_callback == NULL) ? NULL : g_cclosure_new ((GCallback) ___lambda67__gbus_name_lost_callback, g_object_ref (self), g_object_unref)));
...
static void panther_dbus_service_on_bus_aquired (PantherDBusService* self, GDBusConnection* connection, PantherPantherView* view) {
	...
	g_return_if_fail (view != NULL);
	{
		...
		Service* _tmp3_ = NULL;
		_tmp0_ = view;
		_tmp1_ = service_new ((GtkWindow*) _tmp0_);
		_g_object_unref0 (self->priv->service);
		self->priv->service = _tmp1_;
		_tmp2_ = connection;
		_tmp3_ = self->priv->service;
		service_register_object (_tmp3_, _tmp2_, "/com/rastersoft/panther", &_inner_error_);
	...
	__catch12_g_io_error:
	{
		...
		_inner_error_ = NULL;
		_tmp4_ = e->message;
		g_critical ("DBusService.vala:42: Could not register service: %s", _tmp4_);
		g_return_if_reached ();
		_g_error_free0 (e);
	}
	__finally12:
...
Service* service_construct (GType object_type, GtkWindow* view) {
	...
	_tmp2_ = view;
	g_signal_connect_object ((GtkWidget*) _tmp2_, "show", (GCallback) _service_on_view_visibility_change_gtk_widget_show, self, 0);
	_tmp3_ = view;
	g_signal_connect_object ((GtkWidget*) _tmp3_, "hide", (GCallback) _service_on_view_visibility_change_gtk_widget_hide, self, 0);
	return self;
}
...
static void service_class_init (ServiceClass * klass) {
	...
	g_signal_new ("visibility_changed", TYPE_SERVICE, G_SIGNAL_RUN_LAST, 0, NULL, NULL, g_cclosure_marshal_VOID__BOOLEAN, G_TYPE_NONE, 1, G_TYPE_BOOLEAN);
}
...
guint service_register_object (gpointer object, GDBusConnection* connection, const gchar* path, GError** error) {
	guint result;
	gpointer *data;
