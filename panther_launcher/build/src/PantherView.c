...
#define PANTHER_PANTHER_VIEW_PANTHER_STYLE_CSS "\n" \
"            .view2 {\n" \
"                border: none;\n" \
"                box-shadow: none;\n" \
"                opacity: 0.5;\n" \
...
PantherPantherView* panther_panther_view_construct (GType object_type) {
	...
	GtkIconTheme* _tmp45_ = NULL;
	PantherBackendAppSystem* _tmp46_ = NULL;
	PantherBackendSynapseSearch* _tmp47_ = NULL;
	PantherBackendAppSystem* _tmp48_ = NULL;
	GeeArrayList* _tmp49_ = NULL;
	PantherBackendAppSystem* _tmp50_ = NULL;
	GeeHashMap* _tmp51_ = NULL;
	PantherBackendAppSystem* _tmp52_ = NULL;
	GSList* _tmp53_ = NULL;
	PantherBackendAppSystem* _tmp54_ = NULL;
	GeeArrayList* _tmp55_ = NULL;
	PantherSettings* _tmp56_ = NULL;
	PantherSettings* _tmp57_ = NULL;
	...
	provider = _tmp37_;
	{
		...
		_tmp38_ = strlen (PANTHER_PANTHER_VIEW_PANTHER_STYLE_CSS);
		_tmp39_ = _tmp38_;
		gtk_css_provider_load_from_data (provider, PANTHER_PANTHER_VIEW_PANTHER_STYLE_CSS, (gssize) _tmp39_, &_inner_error_);
		if (G_UNLIKELY (_inner_error_ != NULL)) {
			goto __catch17_g_error;
		}
		_tmp40_ = gdk_screen_get_default ();
		gtk_style_context_add_provider_for_screen (_tmp40_, (GtkStyleProvider*) provider, (guint) GTK_STYLE_PROVIDER_PRIORITY_APPLICATION);
	}
	goto __finally17;
	__catch17_g_error:
	{
		...
		g_critical ("PantherView.vala:183: %s", _tmp42_);
		_g_error_free0 (e);
	}
	__finally17:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
	...
	_tmp43_ = panther_panther_get_icon_theme ();
	_tmp44_ = _tmp43_;
	_tmp45_ = gtk_icon_theme_get_default ();
	panther_panther_set_icon_theme (_tmp45_);
	_tmp46_ = panther_backend_app_system_new ();
	_g_object_unref0 (self->app_system);
	self->app_system = _tmp46_;
	_tmp47_ = panther_backend_synapse_search_new ();
	_g_object_unref0 (self->priv->synapse);
	self->priv->synapse = _tmp47_;
	_tmp48_ = self->app_system;
	_tmp49_ = panther_backend_app_system_get_categories (_tmp48_);
	_g_object_unref0 (self->priv->categories);
	self->priv->categories = _tmp49_;
	_tmp50_ = self->app_system;
	_tmp51_ = panther_backend_app_system_get_apps (_tmp50_);
	_g_object_unref0 (self->apps);
	self->apps = _tmp51_;
	_tmp52_ = self->app_system;
	_tmp53_ = panther_backend_app_system_get_apps_by_name (_tmp52_);
	__g_slist_free__g_object_unref0_0 (self->app_name);
	self->app_name = _tmp53_;
	_tmp54_ = self->app_system;
	_tmp55_ = panther_backend_app_system_get_saved_apps (_tmp54_);
	_g_object_unref0 (self->saved_apps);
	self->saved_apps = _tmp55_;
	_tmp56_ = panther_panther_get_settings ();
	_tmp57_ = _tmp56_;
	_tmp58_ = panther_settings_get_screen_resolution (_tmp57_);
	_tmp59_ = _tmp58_;
	_tmp60_ = geometry;
	...
	_tmp67_ = _tmp66_;
	_tmp68_ = g_strconcat (_tmp63_, "x", _tmp67_, NULL);
	_tmp69_ = _tmp68_;
	_tmp70_ = g_strcmp0 (_tmp59_, _tmp69_) != 0;
	_g_free0 (_tmp69_);
	_g_free0 (_tmp67_);
	_g_free0 (_tmp63_);
	if (_tmp70_) {
	...
	g_debug ("PantherView.vala:220: Apps loaded");
	_g_object_unref0 (provider);
	return self;
}
...
static void panther_panther_view_setup_size (PantherPantherView* self) {
	...
	gint _tmp37_ = 0;
	g_return_if_fail (self != NULL);
	g_debug ("PantherView.vala:233: In setup_size ()");
	_tmp0_ = gtk_window_get_screen ((GtkWindow*) self);
	_tmp1_ = _tmp0_;
	_tmp2_ = gdk_screen_get_primary_monitor (_tmp1_);
	self->priv->primary_monitor = _tmp2_;
...
static void panther_panther_view_setup_ui (PantherPantherView* self) {
	...
	PantherSelector* _tmp16_ = NULL;
	PantherSelector* _tmp17_ = NULL;
	GtkRevealer* _tmp18_ = NULL;
	GtkRevealer* _tmp19_ = NULL;
	GtkRevealer* _tmp20_ = NULL;
	PantherSelector* _tmp21_ = NULL;
	PantherSettings* _tmp22_ = NULL;
	PantherSettings* _tmp23_ = NULL;
	...
	PantherSettings* _tmp42_ = NULL;
	PantherSettings* _tmp43_ = NULL;
	gint _tmp44_ = 0;
	PantherSettings* _tmp45_ = NULL;
	PantherSettings* _tmp46_ = NULL;
	gint _tmp47_ = 0;
	PantherWidgetsGrid* _tmp48_ = NULL;
	GtkStack* _tmp49_ = NULL;
	PantherWidgetsGrid* _tmp50_ = NULL;
	PantherWidgetsCategoryView* _tmp51_ = NULL;
	GtkStack* _tmp52_ = NULL;
	PantherWidgetsCategoryView* _tmp53_ = NULL;
	PantherWidgetsSearchView* _tmp54_ = NULL;
	PantherWidgetsSearchView* _tmp55_ = NULL;
	PantherWidgetsSearchView* _tmp56_ = NULL;
	GtkStack* _tmp57_ = NULL;
	PantherWidgetsSearchView* _tmp58_ = NULL;
	...
	GtkFrame* _tmp68_ = NULL;
	GtkEventBox* _tmp69_ = NULL;
	PantherSettings* _tmp70_ = NULL;
	PantherSettings* _tmp71_ = NULL;
	gboolean _tmp72_ = FALSE;
	gboolean _tmp73_ = FALSE;
	GError * _inner_error_ = NULL;
	g_return_if_fail (self != NULL);
	g_debug ("PantherView.vala:256: In setup_ui ()");
	...
	provider = _tmp0_;
	{
		...
		gint _tmp2_ = 0;
		GdkScreen* _tmp3_ = NULL;
		_tmp1_ = strlen (PANTHER_PANTHER_VIEW_PANTHER_STYLE_CSS);
		_tmp2_ = _tmp1_;
		gtk_css_provider_load_from_data (provider, PANTHER_PANTHER_VIEW_PANTHER_STYLE_CSS, (gssize) _tmp2_, &_inner_error_);
		if (G_UNLIKELY (_inner_error_ != NULL)) {
	...
	__catch18_g_error:
	{
		...
		g_critical ("PantherView.vala:263: %s", _tmp5_);
		_g_error_free0 (e);
	}
	__finally18:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
	...
	_tmp15_ = panther_selector_new (GTK_ORIENTATION_HORIZONTAL);
	...
	_tmp22_ = panther_panther_get_settings ();
	_tmp23_ = _tmp22_;
	_tmp24_ = panther_settings_get_use_category (_tmp23_);
	_tmp25_ = _tmp24_;
	if (_tmp25_) {
		PantherSelector* _tmp26_ = NULL;
		_tmp26_ = self->view_selector;
		panther_selector_set_selected (_tmp26_, 1);
	} else {
		PantherSelector* _tmp27_ = NULL;
		_tmp27_ = self->view_selector;
		panther_selector_set_selected (_tmp27_, 0);
	}
	...
	_tmp30_ = _ ("Search Apps");
	gtk_entry_set_placeholder_text ((GtkEntry*) _tmp29_, _tmp30_);
	...
	_tmp33_ = self->search_entry;
	gtk_widget_set_margin_end ((GtkWidget*) _tmp33_, 6);
	_tmp34_ = panther_panther_get_settings ();
	_tmp35_ = _tmp34_;
	_tmp36_ = panther_settings_get_show_category_filter (_tmp35_);
	_tmp37_ = _tmp36_;
	if (_tmp37_) {
	}
	_tmp38_ = self->top;
	_tmp39_ = self->search_entry;
	...
	self->stack = _tmp40_;
	_tmp41_ = self->stack;
	gtk_stack_set_transition_type (_tmp41_, GTK_STACK_TRANSITION_TYPE_SLIDE_LEFT_RIGHT);
	_tmp42_ = panther_panther_get_settings ();
	_tmp43_ = _tmp42_;
	_tmp44_ = _tmp43_->rows;
	_tmp45_ = panther_panther_get_settings ();
	_tmp46_ = _tmp45_;
	_tmp47_ = _tmp46_->columns;
	_tmp48_ = panther_widgets_grid_new (_tmp44_, _tmp47_);
	g_object_ref_sink (_tmp48_);
	_g_object_unref0 (self->priv->grid_view);
	self->priv->grid_view = _tmp48_;
	_tmp49_ = self->stack;
	_tmp50_ = self->priv->grid_view;
	gtk_stack_add_named (_tmp49_, (GtkWidget*) _tmp50_, "normal");
	_tmp51_ = panther_widgets_category_view_new (self);
	g_object_ref_sink (_tmp51_);
	_g_object_unref0 (self->priv->category_view);
	self->priv->category_view = _tmp51_;
	_tmp52_ = self->stack;
	_tmp53_ = self->priv->category_view;
	gtk_stack_add_named (_tmp52_, (GtkWidget*) _tmp53_, "category");
	_tmp54_ = panther_widgets_search_view_new (self);
	g_object_ref_sink (_tmp54_);
	_g_object_unref0 (self->priv->search_view);
	self->priv->search_view = _tmp54_;
	_tmp55_ = self->priv->search_view;
	gtk_widget_set_margin_end ((GtkWidget*) _tmp55_, 6);
	_tmp56_ = self->priv->search_view;
	g_signal_connect_object (_tmp56_, "start-search", (GCallback) ___lambda51__panther_widgets_search_view_start_search, self, 0);
	_tmp57_ = self->stack;
	_tmp58_ = self->priv->search_view;
	gtk_stack_add_named (_tmp57_, (GtkWidget*) _tmp58_, "search");
	_tmp59_ = self->container;
	_tmp60_ = self->top;
	gtk_grid_attach (_tmp59_, (GtkWidget*) _tmp60_, 0, 0, 1, 1);
	_tmp61_ = self->container;
	_tmp62_ = self->stack;
	gtk_grid_attach (_tmp61_, (GtkWidget*) _tmp62_, 0, 1, 1, 1);
	_tmp63_ = (GtkFrame*) gtk_frame_new (NULL);
	g_object_ref_sink (_tmp63_);
	_g_object_unref0 (self->fcontainer);
	self->fcontainer = _tmp63_;
	_tmp64_ = self->fcontainer;
	_tmp65_ = self->container;
	...
	self->priv->event_box = _tmp66_;
	_tmp67_ = self->priv->event_box;
	_tmp68_ = self->fcontainer;
	gtk_container_add ((GtkContainer*) _tmp67_, (GtkWidget*) _tmp68_);
	_tmp69_ = self->priv->event_box;
	gtk_container_add ((GtkContainer*) self, (GtkWidget*) _tmp69_);
	_tmp70_ = panther_panther_get_settings ();
	_tmp71_ = _tmp70_;
	_tmp72_ = panther_settings_get_use_category (_tmp71_);
	_tmp73_ = _tmp72_;
	if (_tmp73_) {
	...
	g_debug ("PantherView.vala:337: Ui setup completed");
	_g_object_unref0 (provider);
}
...
void panther_panther_view_reposition (PantherPantherView* self) {
	...
	g_return_if_fail (self != NULL);
	g_debug ("PantherView.vala:505: Repositioning");
	_tmp0_ = gtk_window_get_screen ((GtkWindow*) self);
...
static void panther_panther_view_read_settings (PantherPantherView* self, gboolean first_start, gboolean check_columns, gboolean check_rows) {
	...
	if (!_tmp20_) {
		...
		PantherWidgetsGrid* _tmp25_ = NULL;
		gint _tmp26_ = 0;
		gint _tmp27_ = 0;
		PantherWidgetsCategoryView* _tmp28_ = NULL;
		PantherWidgetsCategoryView* _tmp29_ = NULL;
		GeeHashMap* _tmp30_ = NULL;
		PantherWidgetsCategoryView* _tmp31_ = NULL;
		PantherWidgetsSidebar* _tmp32_ = NULL;
		gint _tmp33_ = 0;
		gint _tmp34_ = 0;
		...
		panther_widgets_grid_resize (_tmp25_, _tmp26_, _tmp27_);
		_tmp28_ = self->priv->category_view;
		_tmp29_ = self->priv->category_view;
		_tmp30_ = _tmp29_->category_ids;
		_tmp31_ = self->priv->category_view;
		_tmp32_ = _tmp31_->category_switcher;
		_tmp33_ = panther_widgets_sidebar_get_selected (_tmp32_);
		_tmp34_ = _tmp33_;
		_tmp35_ = gee_abstract_map_get ((GeeAbstractMap*) _tmp30_, (gpointer) ((gintptr) _tmp34_));
		_tmp36_ = (gchar*) _tmp35_;
		panther_widgets_category_view_show_filtered_apps (_tmp28_, _tmp36_);
		_g_free0 (_tmp36_);
	}
}
