...
enum  {
	...
	PANTHER_PANTHER_VIEW_CAT_SAVED
};
...
static void __lambda50_ (PantherPantherView* self, SynapseSearchMatch* match, SynapseMatch* target);
...
static void ___lambda50__panther_widgets_search_view_start_search (PantherWidgetsSearchView* _sender, SynapseSearchMatch* search_match, SynapseMatch* target, gpointer self);
...
static gboolean ___lambda24_ (PantherPantherView* self);
...
static gboolean __lambda53_ (PantherPantherView* self);
static gboolean ___lambda53__gtk_widget_focus_in_event (GtkWidget* _sender, GdkEventFocus* event, gpointer self);
static void __lambda54_ (PantherPantherView* self);
static gboolean _panther_panther_view_reset_avoid_show_gsource_func (gpointer self);
static void ___lambda54__gtk_widget_hide (GtkWidget* _sender, gpointer self);
...
static void __lambda55_ (PantherPantherView* self, GtkMenu* menu);
static void __lambda56_ (PantherPantherView* self);
static void ___lambda56__gtk_widget_hide (GtkWidget* _sender, gpointer self);
static void ___lambda55__gtk_entry_populate_popup (GtkEntry* _sender, GtkMenu* popup, gpointer self);
static void __lambda57_ (PantherPantherView* self);
static void ___lambda57__gtk_search_entry_search_changed (GtkSearchEntry* _sender, gpointer self);
...
static void ___lambda58__panther_widgets_search_view_app_launched (PantherWidgetsSearchView* _sender, gpointer self);
void panther_panther_view_populate_grid_view (PantherPantherView* self);
static void __lambda59_ (PantherPantherView* self);
static void ___lambda59__panther_selector_mode_changed (PantherSelector* _sender, gpointer self);
static void __lambda60_ (PantherPantherView* self);
static void ___lambda60__panther_settings_rows_changed (PantherSettings* _sender, gpointer self);
static void __lambda61_ (PantherPantherView* self);
static void ___lambda61__panther_settings_columns_changed (PantherSettings* _sender, gpointer self);
static void __lambda62_ (PantherPantherView* self);
static void ___lambda62__panther_backend_app_system_changed (PantherBackendAppSystem* _sender, gpointer self);
static void __lambda63_ (PantherPantherView* self);
void panther_panther_view_reposition (PantherPantherView* self);
static void ___lambda63__gdk_screen_size_changed (GdkScreen* _sender, gpointer self);
static void __lambda64_ (PantherPantherView* self);
static void ___lambda64__gdk_screen_monitors_changed (GdkScreen* _sender, gpointer self);
...
static gboolean ___lambda51_ (PantherPantherView* self);
...
static void ____lambda49_ (PantherPantherView* self);
static void _____lambda49__panther_widgets_app_entry_app_launched (PantherWidgetsAppEntry* _sender, gpointer self);
...
static void _vala_panther_panther_view_set_property (GObject * object, guint property_id, const GValue * value, GParamSpec * pspec);
...
PantherSelector* panther_selector_construct (GType object_type, GtkOrientation orientation) {
	...
	self->priv->view_cats = _tmp1_;
	_tmp2_ = self->priv->view_cats;
	gtk_box_pack_start ((GtkBox*) self, (GtkWidget*) _tmp2_, FALSE, FALSE, (guint) 0);
	_tmp3_ = self->priv->view_cats;
	g_signal_connect_object ((GtkWidget*) _tmp3_, "button-release-event", (GCallback) ___lambda4__gtk_widget_button_release_event, self, 0);
	return self;
}
	...
	if (_tmp0_ != _tmp1_) {
		...
		switch (_tmp3_) {
			...
			case 1:
			{
				...
				gtk_toggle_button_set_active (_tmp5_, TRUE);
				break;
			}
			default:
			break;
...
PantherPantherView* panther_panther_view_construct (GType object_type) {
	...
	GSList* _tmp47_ = NULL;
	PantherBackendAppSystem* _tmp48_ = NULL;
	GeeArrayList* _tmp49_ = NULL;
	PantherSettings* _tmp50_ = NULL;
	PantherSettings* _tmp51_ = NULL;
	...
	_tmp48_ = self->app_system;
	_tmp49_ = panther_backend_app_system_get_saved_apps (_tmp48_);
	_g_object_unref0 (self->saved_apps);
	self->saved_apps = _tmp49_;
	_tmp50_ = panther_panther_get_settings ();
	_tmp51_ = _tmp50_;
	_tmp52_ = panther_settings_get_screen_resolution (_tmp51_);
	_tmp53_ = _tmp52_;
	_tmp54_ = geometry;
	...
	_tmp61_ = _tmp60_;
	_tmp62_ = g_strconcat (_tmp57_, "x", _tmp61_, NULL);
	_tmp63_ = _tmp62_;
	_tmp64_ = g_strcmp0 (_tmp53_, _tmp63_) != 0;
	_g_free0 (_tmp63_);
	_g_free0 (_tmp61_);
	_g_free0 (_tmp57_);
	if (_tmp64_) {
	...
	_tmp65_ = panther_panther_view_calculate_grid_height (self);
	g_object_set ((GtkWidget*) self, "height-request", _tmp65_ + PANTHER_PIXELS_BOTTOM_SPACE, NULL);
	panther_panther_view_setup_ui (self);
	panther_panther_view_connect_signals (self);
	g_debug ("PantherView.vala:201: Apps loaded");
	return self;
}
...
static void panther_panther_view_setup_size (PantherPantherView* self) {
	...
	gint _tmp37_ = 0;
	g_return_if_fail (self != NULL);
	g_debug ("PantherView.vala:214: In setup_size ()");
	_tmp0_ = gtk_window_get_screen ((GtkWindow*) self);
	_tmp1_ = _tmp0_;
	_tmp2_ = gdk_screen_get_primary_monitor (_tmp1_);
	self->priv->primary_monitor = _tmp2_;
...
static void ___lambda50__panther_widgets_search_view_start_search (PantherWidgetsSearchView* _sender, SynapseSearchMatch* search_match, SynapseMatch* target, gpointer self) {
	__lambda50_ ((PantherPantherView*) self, search_match, target);
}
...
static void panther_panther_view_setup_ui (PantherPantherView* self) {
	...
	PantherSettings* _tmp30_ = NULL;
	PantherSettings* _tmp31_ = NULL;
	gint _tmp32_ = 0;
	PantherSettings* _tmp33_ = NULL;
	PantherSettings* _tmp34_ = NULL;
	gint _tmp35_ = 0;
	PantherWidgetsGrid* _tmp36_ = NULL;
	GtkStack* _tmp37_ = NULL;
	PantherWidgetsGrid* _tmp38_ = NULL;
	PantherWidgetsCategoryView* _tmp39_ = NULL;
	GtkStack* _tmp40_ = NULL;
	PantherWidgetsCategoryView* _tmp41_ = NULL;
	PantherWidgetsSearchView* _tmp42_ = NULL;
	PantherWidgetsSearchView* _tmp43_ = NULL;
	PantherWidgetsSearchView* _tmp44_ = NULL;
	GtkStack* _tmp45_ = NULL;
	PantherWidgetsSearchView* _tmp46_ = NULL;
	...
	PantherSettings* _tmp58_ = NULL;
	PantherSettings* _tmp59_ = NULL;
	gboolean _tmp60_ = FALSE;
	gboolean _tmp61_ = FALSE;
	g_return_if_fail (self != NULL);
	g_debug ("PantherView.vala:237: In setup_ui ()");
	...
	_tmp31_ = _tmp30_;
	_tmp32_ = _tmp31_->rows;
	_tmp33_ = panther_panther_get_settings ();
	_tmp34_ = _tmp33_;
	_tmp35_ = _tmp34_->columns;
	_tmp36_ = panther_widgets_grid_new (_tmp32_, _tmp35_);
	g_object_ref_sink (_tmp36_);
	_g_object_unref0 (self->priv->grid_view);
	self->priv->grid_view = _tmp36_;
	_tmp37_ = self->stack;
	_tmp38_ = self->priv->grid_view;
	gtk_stack_add_named (_tmp37_, (GtkWidget*) _tmp38_, "normal");
	_tmp39_ = panther_widgets_category_view_new (self);
	g_object_ref_sink (_tmp39_);
	_g_object_unref0 (self->priv->category_view);
	self->priv->category_view = _tmp39_;
	_tmp40_ = self->stack;
	_tmp41_ = self->priv->category_view;
	gtk_stack_add_named (_tmp40_, (GtkWidget*) _tmp41_, "category");
	_tmp42_ = panther_widgets_search_view_new (self);
	g_object_ref_sink (_tmp42_);
	_g_object_unref0 (self->priv->search_view);
	self->priv->search_view = _tmp42_;
	_tmp43_ = self->priv->search_view;
	gtk_widget_set_margin_end ((GtkWidget*) _tmp43_, 6);
	_tmp44_ = self->priv->search_view;
	g_signal_connect_object (_tmp44_, "start-search", (GCallback) ___lambda50__panther_widgets_search_view_start_search, self, 0);
	_tmp45_ = self->stack;
	_tmp46_ = self->priv->search_view;
	gtk_stack_add_named (_tmp45_, (GtkWidget*) _tmp46_, "search");
	_tmp47_ = self->container;
	_tmp48_ = self->top;
	...
	self->fcontainer = _tmp51_;
	_tmp52_ = self->fcontainer;
	_tmp53_ = self->container;
	...
	self->priv->event_box = _tmp54_;
	_tmp55_ = self->priv->event_box;
	_tmp56_ = self->fcontainer;
	gtk_container_add ((GtkContainer*) _tmp55_, (GtkWidget*) _tmp56_);
	_tmp57_ = self->priv->event_box;
	gtk_container_add ((GtkContainer*) self, (GtkWidget*) _tmp57_);
	_tmp58_ = panther_panther_get_settings ();
	_tmp59_ = _tmp58_;
	_tmp60_ = panther_settings_get_use_category (_tmp59_);
	_tmp61_ = _tmp60_;
	if (_tmp61_) {
	...
	g_debug ("PantherView.vala:310: Ui setup completed");
}
...
static gboolean ____lambda24__gsource_func (gpointer self) {
	gboolean result;
	result = ___lambda24_ ((PantherPantherView*) self);
	return result;
}
...
void panther_panther_view_grab_device (PantherPantherView* self) {
	...
	if (_tmp21_) {
		g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) 100, ____lambda24__gsource_func, g_object_ref (self), g_object_unref);
	}
...
void panther_panther_view_add_saved (PantherPantherView* self, const gchar* app) {
	...
	GSList* _tmp5_ = NULL;
	PantherBackendAppSystem* _tmp6_ = NULL;
	GeeArrayList* _tmp7_ = NULL;
	PantherWidgetsCategoryView* _tmp8_ = NULL;
	gchar* app_name = NULL;
	...
	_tmp7_ = panther_backend_app_system_get_saved_apps (_tmp6_);
	_g_object_unref0 (self->saved_apps);
	self->saved_apps = _tmp7_;
	_tmp8_ = self->priv->category_view;
	panther_widgets_category_view_setup_sidebar (_tmp8_);
	_tmp9_ = app;
	_tmp10_ = app;
	_tmp11_ = strlen (_tmp10_);
	_tmp12_ = _tmp11_;
	_tmp13_ = string_substring (_tmp9_, (glong) 0, (glong) (_tmp12_ - 8));
	app_name = _tmp13_;
	_tmp14_ = app_name;
	_tmp15_ = _ (_tmp14_);
	_tmp16_ = g_notification_new (_tmp15_);
	note = _tmp16_;
	_tmp17_ = self->priv->saved_cat;
	if (_tmp17_) {
		GNotification* _tmp18_ = NULL;
		const gchar* _tmp19_ = NULL;
		_tmp18_ = note;
		_tmp19_ = _ ("Removed from saved");
		g_notification_set_body (_tmp18_, _tmp19_);
	} else {
		GNotification* _tmp20_ = NULL;
		const gchar* _tmp21_ = NULL;
		_tmp20_ = note;
		_tmp21_ = _ ("Added to saved");
		g_notification_set_body (_tmp20_, _tmp21_);
	}
	_tmp22_ = g_application_get_default ();
	_tmp23_ = note;
	g_application_send_notification (_tmp22_, NULL, _tmp23_);
...
static gboolean ___lambda53__gtk_widget_focus_in_event (GtkWidget* _sender, GdkEventFocus* event, gpointer self) {
	gboolean result;
	result = __lambda53_ ((PantherPantherView*) self);
	return result;
}
...
static void __lambda55_ (PantherPantherView* self, GtkMenu* menu) {
	...
	_tmp0_ = menu;
	g_signal_connect_object ((GtkWidget*) _tmp0_, "hide", (GCallback) ___lambda56__gtk_widget_hide, self, 0);
}


static void ___lambda55__gtk_entry_populate_popup (GtkEntry* _sender, GtkMenu* popup, gpointer self) {
	__lambda55_ ((PantherPantherView*) self, popup);
}
...
static void panther_panther_view_connect_signals (PantherPantherView* self) {
	...
	g_return_if_fail (self != NULL);
	g_warning ("PantherView.vala:403: connect signals");
	g_signal_connect_object ((GtkWidget*) self, "focus-in-event", (GCallback) ___lambda53__gtk_widget_focus_in_event, self, 0);
	g_signal_connect_object ((GtkWidget*) self, "hide", (GCallback) ___lambda54__gtk_widget_hide, self, 0);
	_tmp0_ = self->priv->event_box;
	...
	g_signal_connect_object ((GtkEntry*) _tmp2_, "populate-popup", (GCallback) ___lambda55__gtk_entry_populate_popup, self, 0);
	_tmp3_ = self->search_entry;
	g_signal_connect_object (_tmp3_, "search-changed", (GCallback) ___lambda57__gtk_search_entry_search_changed, self, 0);
	...
	g_signal_connect_object (_tmp6_, "app-launched", (GCallback) ___lambda58__panther_widgets_search_view_app_launched, self, 0);
	panther_panther_view_populate_grid_view (self);
	_tmp7_ = self->view_selector;
	g_signal_connect_object (_tmp7_, "mode-changed", (GCallback) ___lambda59__panther_selector_mode_changed, self, 0);
	_tmp8_ = panther_panther_get_settings ();
	_tmp9_ = _tmp8_;
	g_signal_connect_object (_tmp9_, "rows-changed", (GCallback) ___lambda60__panther_settings_rows_changed, self, 0);
	_tmp10_ = panther_panther_get_settings ();
	_tmp11_ = _tmp10_;
	g_signal_connect_object (_tmp11_, "columns-changed", (GCallback) ___lambda61__panther_settings_columns_changed, self, 0);
	_tmp12_ = self->app_system;
	g_signal_connect_object (_tmp12_, "changed", (GCallback) ___lambda62__panther_backend_app_system_changed, self, 0);
	_tmp13_ = gtk_window_get_screen ((GtkWindow*) self);
	_tmp14_ = _tmp13_;
	g_signal_connect_object (_tmp14_, "size-changed", (GCallback) ___lambda63__gdk_screen_size_changed, self, 0);
	_tmp15_ = gtk_window_get_screen ((GtkWindow*) self);
	_tmp16_ = _tmp15_;
	g_signal_connect_object (_tmp16_, "monitors-changed", (GCallback) ___lambda64__gdk_screen_monitors_changed, self, 0);
	_tmp17_ = gtk_widget_get_style_context ((GtkWidget*) self);
	g_signal_connect_object ((GObject*) _tmp17_, "notify::direction", (GCallback) ___lambda65__g_object_notify, self, 0);
...
void panther_panther_view_reposition (PantherPantherView* self) {
	...
	g_return_if_fail (self != NULL);
	g_debug ("PantherView.vala:478: Repositioning");
	_tmp0_ = gtk_window_get_screen ((GtkWindow*) self);
...
static gboolean ____lambda51__gsource_func (gpointer self) {
	gboolean result;
	result = ___lambda51_ ((PantherPantherView*) self);
	return result;
}
...
static gboolean panther_panther_view_search_co (PantherPantherViewSearchData* _data_) {
	...
	if (g_strcmp0 (_data_->_tmp3_, "") == 0) {
		g_idle_add_full (G_PRIORITY_DEFAULT_IDLE, ____lambda51__gsource_func, g_object_ref (_data_->self), g_object_unref);
	...
	g_idle_add_full (G_PRIORITY_DEFAULT_IDLE, ___lambda52__gsource_func, block3_data_ref (_data_->_data3_), block3_data_unref);
	_g_free0 (_data_->stripped);
	block3_data_unref (_data_->_data3_);
	_data_->_data3_ = NULL;
	if (_data_->_state_ == 0) {
...
static void _____lambda49__panther_widgets_app_entry_app_launched (PantherWidgetsAppEntry* _sender, gpointer self) {
	____lambda49_ ((PantherPantherView*) self);
}
	...
	_tmp2_ = panther_backend_app_system_get_apps_by_name (_tmp1_);
	{
		...
		for (app_it = app_collection; app_it != NULL; app_it = app_it->next) {
			...
			app = _tmp3_;
			{
				...
				app_entry = _tmp5_;
				_tmp6_ = app_entry;
				g_signal_connect_object (_tmp6_, "app-launched", (GCallback) _____lambda49__panther_widgets_app_entry_app_launched, self, 0);
				_tmp7_ = self->priv->grid_view;
				_tmp8_ = app_entry;
...
void panther_panther_view_set_cat_saved (PantherPantherView* self, gboolean value) {
	...
	g_return_if_fail (self != NULL);
	_tmp0_ = value;
	self->priv->saved_cat = _tmp0_;
	g_object_notify ((GObject *) self, "cat-saved");
}
...
static void panther_panther_view_class_init (PantherPantherViewClass * klass) {
	...
	G_OBJECT_CLASS (klass)->set_property = _vala_panther_panther_view_set_property;
	...
	g_object_class_install_property (G_OBJECT_CLASS (klass), PANTHER_PANTHER_VIEW_CAT_SAVED, g_param_spec_boolean ("cat-saved", "cat-saved", "cat-saved", FALSE, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE | G_PARAM_WRITABLE));
}
...
static void _vala_panther_panther_view_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec) {
	...
	switch (property_id) {
		...
		break;
		case PANTHER_PANTHER_VIEW_CAT_SAVED:
		g_value_set_boolean (value, panther_panther_view_get_cat_saved (self));
		break;
		default:
		G_OBJECT_WARN_INVALID_PROPERTY_ID (object, property_id, pspec);
		break;
...
static void _vala_panther_panther_view_set_property (GObject * object, guint property_id, const GValue * value, GParamSpec * pspec) {
	...
	switch (property_id) {
		case PANTHER_PANTHER_VIEW_CAT_SAVED:
		panther_panther_view_set_cat_saved (self, g_value_get_boolean (value));
		break;
		default:
		G_OBJECT_WARN_INVALID_PROPERTY_ID (object, property_id, pspec);
		break;
