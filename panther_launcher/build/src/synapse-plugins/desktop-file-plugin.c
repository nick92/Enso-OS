...
static void ___lambda19_ (Block14Data* _data14_);
...
static void ____lambda19__synapse_desktop_file_plugin_load_complete (SynapseDesktopFilePlugin* _sender, gpointer self);
...
static void _synapse_desktop_file_plugin___lambda20_ (SynapseDesktopFilePlugin* self);
static void __synapse_desktop_file_plugin___lambda20__synapse_desktop_file_service_reload_started (SynapseDesktopFileService* _sender, gpointer self);
static void _synapse_desktop_file_plugin___lambda21_ (SynapseDesktopFilePlugin* self);
static void __synapse_desktop_file_plugin___lambda21__synapse_desktop_file_service_reload_done (SynapseDesktopFileService* _sender, gpointer self);
...
static gboolean synapse_desktop_file_plugin_real_search_co (SynapseDesktopFilePluginSearchData* _data_) {
	...
	if (_data_->_tmp0_) {
		_data_->_tmp1_ = 0UL;
		_data_->_tmp1_ = g_signal_connect_data (_data_->self, "load-complete", (GCallback) ____lambda19__synapse_desktop_file_plugin_load_complete, block14_data_ref (_data_->_data14_), (GClosureNotify) block14_data_unref, 0);
...
static void __synapse_desktop_file_plugin___lambda20__synapse_desktop_file_service_reload_started (SynapseDesktopFileService* _sender, gpointer self) {
	_synapse_desktop_file_plugin___lambda20_ ((SynapseDesktopFilePlugin*) self);
}
...
static GObject * synapse_desktop_file_plugin_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	dfs = _tmp2_;
	_tmp3_ = dfs;
	g_signal_connect_object (_tmp3_, "reload-started", (GCallback) __synapse_desktop_file_plugin___lambda20__synapse_desktop_file_service_reload_started, self, 0);
	_tmp4_ = dfs;
	g_signal_connect_object (_tmp4_, "reload-done", (GCallback) __synapse_desktop_file_plugin___lambda21__synapse_desktop_file_service_reload_done, self, 0);
	synapse_desktop_file_plugin_load_all_desktop_files (self, NULL, NULL);
	_g_object_unref0 (dfs);
	return obj;
}
