...
enum  {
	...
	PANTHER_PANTHER_SET_VIEW_WIDTH,
	PANTHER_PANTHER_SET_VIEW_HEIGHT
};
...
gboolean panther_panther_realize_view (PantherPanther* self, cairo_t* cr);
...
static void ___lambda68_ (void);
static void ____lambda68__gbus_name_acquired_callback (GDBusConnection* connection, const gchar* name, gpointer self);
static void ___lambda69_ (void);
static void ____lambda69__gbus_name_lost_callback (GDBusConnection* connection, const gchar* name, gpointer self);
GtkIconTheme* panther_panther_get_icon_theme (void);
void panther_panther_set_icon_theme (GtkIconTheme* value);
void panther_panther_set_set_view_width (PantherPanther* self, gint value);
void panther_panther_set_set_view_height (PantherPanther* self, gint value);
...
gint panther_panther_main (gchar** args, int args_length1) {
	...
	_tmp12_ = app;
	_tmp13_ = gtk_application_get_windows ((GtkApplication*) _tmp12_);
	if (_tmp13_ == NULL) {
		PantherPanther* _tmp14_ = NULL;
		PantherPanther* _tmp15_ = NULL;
		gchar** _tmp16_ = NULL;
		gint _tmp16__length1 = 0;
		gint _tmp17_ = 0;
		_tmp14_ = panther_panther_new ();
		_g_object_unref0 (app);
		app = _tmp14_;
		g_bus_own_name_with_closures (G_BUS_TYPE_SESSION, "com.rastersoft.panther.remotecontrol", G_BUS_NAME_OWNER_FLAGS_NONE, (GClosure*) ((_on_bus_aquired_gbus_acquired_callback == NULL) ? NULL : g_cclosure_new ((GCallback) _on_bus_aquired_gbus_acquired_callback, NULL, NULL)), (GClosure*) ((____lambda68__gbus_name_acquired_callback == NULL) ? NULL : g_cclosure_new ((GCallback) ____lambda68__gbus_name_acquired_callback, NULL, NULL)), (GClosure*) ((____lambda69__gbus_name_lost_callback == NULL) ? NULL : g_cclosure_new ((GCallback) ____lambda69__gbus_name_lost_callback, NULL, NULL)));
		_tmp15_ = app;
		_tmp16_ = args;
		_tmp16__length1 = args_length1;
		_tmp17_ = g_application_run ((GApplication*) _tmp15_, _tmp16__length1, _tmp16_);
		result = _tmp17_;
		return result;
	} else {
		PantherPanther* _tmp18_ = NULL;
		_tmp18_ = app;
		g_application_activate ((GApplication*) _tmp18_);
		result = 1;
		return result;
	}
}
...
void panther_panther_set_set_view_width (PantherPanther* self, gint value) {
	...
	_tmp0_ = value;
	self->priv->view_width = _tmp0_;
	g_object_notify ((GObject *) self, "set-view-width");
}
...
void panther_panther_set_set_view_height (PantherPanther* self, gint value) {
	...
	g_return_if_fail (self != NULL);
	_tmp0_ = value;
	self->priv->view_height = _tmp0_;
	g_object_notify ((GObject *) self, "set-view-height");
}
...
static void panther_panther_class_init (PantherPantherClass * klass) {
	...
	g_object_class_install_property (G_OBJECT_CLASS (klass), PANTHER_PANTHER_SET_VIEW_WIDTH, g_param_spec_int ("set-view-width", "set-view-width", "set-view-width", G_MININT, G_MAXINT, 0, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_WRITABLE));
	g_object_class_install_property (G_OBJECT_CLASS (klass), PANTHER_PANTHER_SET_VIEW_HEIGHT, g_param_spec_int ("set-view-height", "set-view-height", "set-view-height", G_MININT, G_MAXINT, 0, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_WRITABLE));
}
...
static void _vala_panther_panther_set_property (GObject * object, guint property_id, const GValue * value, GParamSpec * pspec) {
	...
	self = G_TYPE_CHECK_INSTANCE_CAST (object, PANTHER_TYPE_PANTHER, PantherPanther);
	switch (property_id) {
		case PANTHER_PANTHER_SET_VIEW_WIDTH:
		panther_panther_set_set_view_width (self, g_value_get_int (value));
		break;
		case PANTHER_PANTHER_SET_VIEW_HEIGHT:
		panther_panther_set_set_view_height (self, g_value_get_int (value));
		break;
		default:
		G_OBJECT_WARN_INVALID_PROPERTY_ID (object, property_id, pspec);
		break;
