...
PantheonGreeter* pantheon_greeter_construct (GType object_type) {
	...
	GValue _tmp88_ = {0};
	GValue _tmp89_ = {0};
	GtkClutterActor* _tmp90_ = NULL;
	ClutterActor* _tmp91_ = NULL;
	ClutterActor* _tmp92_ = NULL;
	ClutterBindConstraint* _tmp93_ = NULL;
	ClutterBindConstraint* _tmp94_ = NULL;
	ClutterActor* _tmp95_ = NULL;
	ClutterBindConstraint* _tmp96_ = NULL;
	ClutterBindConstraint* _tmp97_ = NULL;
	...
	UserListActor* _tmp111_ = NULL;
	ClutterActor* _tmp112_ = NULL;
	GtkClutterEmbed* _tmp113_ = NULL;
	gboolean activate_numlock = FALSE;
	gboolean _tmp119_ = FALSE;
	gint screensaver_timeout = 0;
	Display* display = NULL;
	GdkDisplay* _tmp125_ = NULL;
	Display* _tmp126_ = NULL;
	Display* _tmp127_ = NULL;
	gint _tmp128_ = 0;
	gint _tmp129_ = 0;
	gint _tmp130_ = 0;
	gint _tmp131_ = 0;
	Display* _tmp132_ = NULL;
	gint _tmp133_ = 0;
	LoginGateway* _tmp134_ = NULL;
	LoginGateway* _tmp135_ = NULL;
	gboolean _tmp136_ = FALSE;
	gboolean _tmp137_ = FALSE;
	gchar* select_user = NULL;
	LoginGateway* _tmp139_ = NULL;
	LoginGateway* _tmp140_ = NULL;
	...
	UserList* _tmp170_ = NULL;
	LoginOption* _tmp171_ = NULL;
	LoginOption* _tmp172_ = NULL;
	GtkStyleContext* _tmp177_ = NULL;
	GtkCssProvider* provider = NULL;
	GtkCssProvider* _tmp178_ = NULL;
	GtkCssProvider* _tmp179_ = NULL;
	GdkScreen* _tmp180_ = NULL;
	GtkCssProvider* _tmp181_ = NULL;
	UserListActor* _tmp182_ = NULL;
	ClutterPropertyTransition* _tmp183_ = NULL;
	ClutterPropertyTransition* _tmp184_ = NULL;
	GtkClutterActor* _tmp185_ = NULL;
	ClutterPropertyTransition* _tmp186_ = NULL;
	ClutterPropertyTransition* _tmp187_ = NULL;
	GtkClutterActor* _tmp188_ = NULL;
	ClutterPropertyTransition* _tmp189_ = NULL;
	ClutterPropertyTransition* _tmp190_ = NULL;
	GdkWindow* _tmp191_ = NULL;
	...
	if (_tmp17_) {
		...
		g_message ("PantheonGreeter.vala:91: Using dummy LightDM because LIGHTDM_TO_SERVER" \
"_FD was not found.");
	...
	__catch0_g_error:
	{
		...
		if (!g_error_matches (_tmp46_, G_FILE_ERROR, G_FILE_ERROR_NOENT)) {
			...
			g_warning ("PantheonGreeter.vala:111: Failed to load state from %s: %s\n", _tmp47_, _tmp49_);
		}
		_g_error_free0 (e);
	}
	__finally0:
	...
	self->settings = _tmp50_;
	{
		...
		_tmp52_ = g_build_filename (CONSTANTS_CONF_DIR, "pantheon-greeter.conf", NULL);
		_tmp53_ = _tmp52_;
	...
	__catch1_g_error:
	{
		...
		g_warning ("PantheonGreeter.vala:119: %s", _tmp55_);
		_g_error_free0 (e);
	}
	__finally1:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
	...
	stage = _tmp60_;
	_tmp61_.red = (guint8) 0;
	_tmp61_.green = (guint8) 0;
	_tmp61_.blue = (guint8) 0;
	_tmp61_.alpha = (guint8) 255;
	clutter_actor_set_background_color ((ClutterActor*) stage, &_tmp61_);
	_tmp62_ = lightdm_user_list_get_instance ();
	_tmp63_ = user_list_new (_tmp62_);
	_g_object_unref0 (self->priv->userlist);
	self->priv->userlist = _tmp63_;
	_tmp64_ = self->priv->userlist;
	_tmp65_ = user_list_actor_new (_tmp64_);
	g_object_ref_sink (_tmp65_);
	_g_object_unref0 (self->priv->userlist_actor);
	self->priv->userlist_actor = _tmp65_;
	_tmp66_ = self->priv->userlist_actor;
	clutter_actor_set_opacity ((ClutterActor*) _tmp66_, (guint8) 0);
	_tmp67_ = time_label_new ();
	g_object_ref_sink (_tmp67_);
	time_label = _tmp67_;
	_tmp68_ = (GtkClutterActor*) gtk_clutter_actor_new ();
	g_object_ref_sink (_tmp68_);
	_g_object_unref0 (self->priv->time_actor);
	self->priv->time_actor = _tmp68_;
	_tmp69_ = self->priv->time_actor;
	_tmp70_ = gtk_clutter_actor_get_widget (_tmp69_);
	gtk_container_add (G_TYPE_CHECK_INSTANCE_CAST (_tmp70_, gtk_container_get_type (), GtkContainer), (GtkWidget*) time_label);
	_tmp71_ = power_label_new ();
	g_object_ref_sink (_tmp71_);
	power_label = _tmp71_;
	_tmp72_ = (GtkClutterActor*) gtk_clutter_actor_new ();
	g_object_ref_sink (_tmp72_);
	_g_object_unref0 (self->priv->power_actor);
	self->priv->power_actor = _tmp72_;
	_tmp73_ = self->priv->power_actor;
	_tmp74_ = gtk_clutter_actor_get_widget (_tmp73_);
	gtk_container_add (G_TYPE_CHECK_INSTANCE_CAST (_tmp74_, gtk_container_get_type (), GtkContainer), (GtkWidget*) power_label);
	_tmp75_ = (ClutterShaderEffect*) clutter_shader_effect_new (CLUTTER_FRAGMENT_SHADER);
	g_object_ref_sink (_tmp75_);
	shaderEffectVer = _tmp75_;
	_tmp76_ = wallpaper_new ();
	g_object_ref_sink (_tmp76_);
	_g_object_unref0 (self->priv->wallpaper);
	self->priv->wallpaper = _tmp76_;
	_tmp77_ = (GtkClutterActor*) gtk_clutter_actor_new ();
	g_object_ref_sink (_tmp77_);
	_g_object_unref0 (self->priv->wallpaper_actor);
	self->priv->wallpaper_actor = _tmp77_;
	_tmp78_ = self->priv->wallpaper_actor;
	_tmp79_ = gtk_clutter_actor_get_widget (_tmp78_);
	_tmp80_ = self->priv->wallpaper;
	gtk_container_add (G_TYPE_CHECK_INSTANCE_CAST (_tmp79_, gtk_container_get_type (), GtkContainer), (GtkWidget*) _tmp80_);
	_tmp82_ = pantheon_greeter_load_from_resource (self, CONSTANTS_PKGDATADIR "/shader.glsl", &_inner_error_);
	_tmp81_ = _tmp82_;
	if (G_UNLIKELY (_inner_error_ != NULL)) {
	...
	clutter_shader_effect_set_shader_source (shaderEffectVer, _tmp81_);
	g_value_init (&_tmp83_, G_TYPE_DOUBLE);
	g_value_set_double (&_tmp83_, 1.0);
	clutter_shader_effect_set_uniform_value (shaderEffectVer, "dir", &_tmp83_);
	G_IS_VALUE (&_tmp83_) ? (g_value_unset (&_tmp83_), NULL) : NULL;
	_tmp84_ = self->priv->g_width;
	g_value_init (&_tmp85_, G_TYPE_INT);
	g_value_set_int (&_tmp85_, _tmp84_);
	clutter_shader_effect_set_uniform_value (shaderEffectVer, "width", &_tmp85_);
	G_IS_VALUE (&_tmp85_) ? (g_value_unset (&_tmp85_), NULL) : NULL;
	_tmp86_ = self->priv->g_height;
	g_value_init (&_tmp87_, G_TYPE_INT);
	g_value_set_int (&_tmp87_, _tmp86_);
	clutter_shader_effect_set_uniform_value (shaderEffectVer, "height", &_tmp87_);
	G_IS_VALUE (&_tmp87_) ? (g_value_unset (&_tmp87_), NULL) : NULL;
	g_value_init (&_tmp88_, G_TYPE_DOUBLE);
	g_value_set_double (&_tmp88_, 10.0);
	clutter_shader_effect_set_uniform_value (shaderEffectVer, "radius", &_tmp88_);
	G_IS_VALUE (&_tmp88_) ? (g_value_unset (&_tmp88_), NULL) : NULL;
	g_value_init (&_tmp89_, G_TYPE_DOUBLE);
	g_value_set_double (&_tmp89_, 0.948);
	clutter_shader_effect_set_uniform_value (shaderEffectVer, "brightness", &_tmp89_);
	G_IS_VALUE (&_tmp89_) ? (g_value_unset (&_tmp89_), NULL) : NULL;
	_tmp90_ = self->priv->wallpaper_actor;
	clutter_actor_add_effect_with_name ((ClutterActor*) _tmp90_, "blur", (ClutterEffect*) shaderEffectVer);
	pantheon_greeter_monitors_changed (self);
	_tmp91_ = clutter_actor_new ();
	g_object_ref_sink (_tmp91_);
	_g_object_unref0 (self->priv->greeterbox);
	self->priv->greeterbox = _tmp91_;
	_tmp92_ = self->priv->greeterbox;
	_tmp93_ = (ClutterBindConstraint*) clutter_bind_constraint_new ((ClutterActor*) stage, CLUTTER_BIND_WIDTH, (gfloat) 0);
	g_object_ref_sink (_tmp93_);
	_tmp94_ = _tmp93_;
	clutter_actor_add_constraint (_tmp92_, (ClutterConstraint*) _tmp94_);
	_g_object_unref0 (_tmp94_);
	_tmp95_ = self->priv->greeterbox;
	_tmp96_ = (ClutterBindConstraint*) clutter_bind_constraint_new ((ClutterActor*) stage, CLUTTER_BIND_HEIGHT, (gfloat) 0);
	g_object_ref_sink (_tmp96_);
	_tmp97_ = _tmp96_;
	clutter_actor_add_constraint (_tmp95_, (ClutterConstraint*) _tmp97_);
	_g_object_unref0 (_tmp97_);
	_tmp98_ = self->priv->greeterbox;
	clutter_actor_set_opacity (_tmp98_, (guint) 0);
	_tmp99_ = self->priv->greeterbox;
	clutter_actor_save_easing_state (_tmp99_);
	_tmp100_ = self->priv->greeterbox;
	clutter_actor_set_easing_mode (_tmp100_, CLUTTER_EASE_OUT_QUART);
	_tmp101_ = self->priv->greeterbox;
	clutter_actor_set_easing_duration (_tmp101_, (guint) 250);
	_tmp102_ = self->priv->greeterbox;
	clutter_actor_set_opacity (_tmp102_, (guint8) 255);
	_tmp103_ = self->priv->greeterbox;
	clutter_actor_restore_easing_state (_tmp103_);
	_tmp104_ = self->priv->greeterbox;
	_tmp105_ = self->priv->wallpaper_actor;
	clutter_actor_add_child (_tmp104_, (ClutterActor*) _tmp105_);
	_tmp106_ = self->priv->greeterbox;
	_tmp107_ = self->priv->power_actor;
	clutter_actor_add_child (_tmp106_, (ClutterActor*) _tmp107_);
	_tmp108_ = self->priv->greeterbox;
	_tmp109_ = self->priv->time_actor;
	clutter_actor_add_child (_tmp108_, (ClutterActor*) _tmp109_);
	_tmp110_ = self->priv->greeterbox;
	_tmp111_ = self->priv->userlist_actor;
	clutter_actor_add_child (_tmp110_, (ClutterActor*) _tmp111_);
	_tmp112_ = self->priv->greeterbox;
	clutter_actor_add_child ((ClutterActor*) stage, _tmp112_);
	_tmp113_ = self->priv->clutter;
	gtk_container_add ((GtkContainer*) self, (GtkWidget*) _tmp113_);
	activate_numlock = FALSE;
	{
		gboolean _tmp114_ = FALSE;
		GKeyFile* _tmp115_ = NULL;
		gboolean _tmp116_ = FALSE;
		_tmp115_ = self->settings;
		_tmp116_ = g_key_file_get_boolean (_tmp115_, "greeter", "activate-numlock", &_inner_error_);
		_tmp114_ = _tmp116_;
		if (G_UNLIKELY (_inner_error_ != NULL)) {
			goto __catch2_g_error;
		}
		activate_numlock = _tmp114_;
	}
	goto __finally2;
	__catch2_g_error:
	{
		...
		g_warning ("PantheonGreeter.vala:189: %s", _tmp118_);
		_g_error_free0 (e);
	}
	__finally2:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
	...
	screensaver_timeout = 60;
	{
		...
		gint _tmp122_ = 0;
		_tmp121_ = self->settings;
		_tmp122_ = g_key_file_get_integer (_tmp121_, "greeter", "screensaver-timeout", &_inner_error_);
		_tmp120_ = _tmp122_;
		if (G_UNLIKELY (_inner_error_ != NULL)) {
			goto __catch3_g_error;
		}
		screensaver_timeout = _tmp120_;
	}
	goto __finally3;
	__catch3_g_error:
	{
		...
		g_warning ("PantheonGreeter.vala:199: %s", _tmp124_);
		_g_error_free0 (e);
	}
	__finally3:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
	...
	_tmp125_ = gdk_display_get_default ();
	_tmp126_ = gdk_x11_display_get_xdisplay (G_TYPE_CHECK_INSTANCE_TYPE (_tmp125_, gdk_x11_display_get_type ()) ? ((GdkX11Display*) _tmp125_) : NULL);
	display = _tmp126_;
	_tmp127_ = display;
	XGetScreenSaver (_tmp127_, &_tmp128_, &_tmp129_, &_tmp130_, &_tmp131_);
	self->priv->timeout = _tmp128_;
	self->priv->interval = _tmp129_;
	self->priv->prefer_blanking = _tmp130_;
	self->priv->allow_exposures = _tmp131_;
	_tmp132_ = display;
	_tmp133_ = screensaver_timeout;
	XSetScreenSaver (_tmp132_, _tmp133_, 0, (gint) PANTHEON_GREETER_SCREENSAVER_ACTIVE, (gint) PANTHEON_GREETER_EXPOSURES_DEFAULT_EXPOSURES);
	_tmp134_ = pantheon_greeter_get_login_gateway ();
	_tmp135_ = _tmp134_;
	_tmp136_ = login_gateway_get_lock (_tmp135_);
	_tmp137_ = _tmp136_;
	if (_tmp137_) {
		Display* _tmp138_ = NULL;
		_tmp138_ = display;
		XForceScreenSaver (_tmp138_, (gint) PANTHEON_GREETER_SCREENSAVER_ACTIVE);
	}
	pantheon_greeter_connect_signals (self);
	_tmp139_ = pantheon_greeter_get_login_gateway ();
	_tmp140_ = _tmp139_;
	_tmp141_ = login_gateway_get_select_user (_tmp140_);
	_tmp142_ = _tmp141_;
	_tmp143_ = g_strdup (_tmp142_);
	select_user = _tmp143_;
	_tmp145_ = select_user;
	if (_tmp145_ != NULL) {
		const gchar* _tmp146_ = NULL;
		gchar* _tmp147_ = NULL;
		_tmp146_ = select_user;
		_tmp147_ = g_strdup (_tmp146_);
		_g_free0 (_tmp144_);
		_tmp144_ = _tmp147_;
	} else {
		gchar* _tmp148_ = NULL;
		_tmp148_ = pantheon_greeter_get_greeter_state (self, "last-user");
		_g_free0 (_tmp144_);
		_tmp144_ = _tmp148_;
	}
	_tmp149_ = g_strdup (_tmp144_);
	switch_to_user = _tmp149_;
	_tmp150_ = switch_to_user;
	if (_tmp150_ != NULL) {
		{
			gint i = 0;
			i = 0;
			{
				...
				while (TRUE) {
					gint _tmp153_ = 0;
					UserList* _tmp154_ = NULL;
					gint _tmp155_ = 0;
					gint _tmp156_ = 0;
					UserList* _tmp157_ = NULL;
					gint _tmp158_ = 0;
					LoginOption* _tmp159_ = NULL;
					LoginOption* _tmp160_ = NULL;
					...
					_tmp151_ = FALSE;
					_tmp153_ = i;
					_tmp154_ = self->priv->userlist;
					_tmp155_ = user_list_get_size (_tmp154_);
					_tmp156_ = _tmp155_;
					if (!(_tmp153_ < _tmp156_)) {
						break;
					}
					_tmp157_ = self->priv->userlist;
					_tmp158_ = i;
					_tmp159_ = user_list_get_user (_tmp157_, _tmp158_);
					_tmp160_ = _tmp159_;
					_tmp161_ = login_option_get_name (_tmp160_);
					_tmp162_ = _tmp161_;
					_tmp163_ = switch_to_user;
					_tmp164_ = g_strcmp0 (_tmp162_, _tmp163_) == 0;
					_g_object_unref0 (_tmp160_);
					if (_tmp164_) {
						UserList* _tmp165_ = NULL;
						UserList* _tmp166_ = NULL;
						gint _tmp167_ = 0;
						LoginOption* _tmp168_ = NULL;
						LoginOption* _tmp169_ = NULL;
						_tmp165_ = self->priv->userlist;
						_tmp166_ = self->priv->userlist;
						_tmp167_ = i;
						_tmp168_ = user_list_get_user (_tmp166_, _tmp167_);
						_tmp169_ = _tmp168_;
						user_list_set_current_user (_tmp165_, _tmp169_);
	...
	_tmp170_ = self->priv->userlist;
	_tmp171_ = user_list_get_current_user (_tmp170_);
	_tmp172_ = _tmp171_;
	if (_tmp172_ == NULL) {
		UserList* _tmp173_ = NULL;
		UserList* _tmp174_ = NULL;
		LoginOption* _tmp175_ = NULL;
		LoginOption* _tmp176_ = NULL;
		_tmp173_ = self->priv->userlist;
		_tmp174_ = self->priv->userlist;
		_tmp175_ = user_list_get_user (_tmp174_, 0);
		_tmp176_ = _tmp175_;
		user_list_set_current_user (_tmp173_, _tmp176_);
		_g_object_unref0 (_tmp176_);
	}
	_tmp177_ = gtk_widget_get_style_context ((GtkWidget*) self);
	gtk_style_context_add_class (_tmp177_, "greeter");
	_tmp178_ = gtk_css_provider_new ();
	provider = _tmp178_;
	_tmp179_ = provider;
	gtk_css_provider_load_from_resource (_tmp179_, "io/elementary/greeter/Greeter.css");
	_tmp180_ = gdk_screen_get_default ();
	_tmp181_ = provider;
	gtk_style_context_add_provider_for_screen (_tmp180_, (GtkStyleProvider*) _tmp181_, (guint) GTK_STYLE_PROVIDER_PRIORITY_APPLICATION);
	gtk_widget_show_all ((GtkWidget*) self);
	_tmp182_ = self->priv->userlist_actor;
	_tmp183_ = pantheon_greeter_fade_in_actor (self, (ClutterActor*) _tmp182_);
	_tmp184_ = _tmp183_;
	_g_object_unref0 (_tmp184_);
	_tmp185_ = self->priv->time_actor;
	_tmp186_ = pantheon_greeter_fade_in_actor (self, (ClutterActor*) _tmp185_);
	_tmp187_ = _tmp186_;
	_g_object_unref0 (_tmp187_);
	_tmp188_ = self->priv->wallpaper_actor;
	_tmp189_ = pantheon_greeter_fade_in_actor (self, (ClutterActor*) _tmp188_);
	_tmp190_ = _tmp189_;
	_g_object_unref0 (_tmp190_);
	_tmp191_ = gtk_widget_get_window ((GtkWidget*) self);
	gdk_window_focus (_tmp191_, (guint32) GDK_CURRENT_TIME);
...
static void __lambda27_ (PantheonGreeter* self) {
	...
	g_message ("PantheonGreeter.vala:263: restore user timeout: %d", _tmp2_);
...
static void pantheon_greeter_reposition (PantheonGreeter* self) {
	...
	_tmp16_ = _tmp15_;
	clutter_actor_set_x ((ClutterActor*) _tmp12_, (_tmp13_ - _tmp16_) - 100);
	...
	switch (_tmp1_) {
		case GDK_KEY_Num_Lock:
		{
			...
			__catch4_g_error:
			{
				...
				g_warning ("PantheonGreeter.vala:384: %s", _tmp6_);
				_g_error_free0 (e);
			}
			__finally4:
			if (G_UNLIKELY (_inner_error_ != NULL)) {
...
void pantheon_greeter_set_greeter_state (PantheonGreeter* self, const gchar* key, const gchar* value) {
	...
	__catch6_g_error:
	{
		...
		g_warning ("PantheonGreeter.vala:430: Failed to write state: %s", _tmp7_);
		_g_error_free0 (e);
	}
	__finally6:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
...
gint _vala_main (gchar** args, int args_length1) {
	...
	if (init != CLUTTER_INIT_SUCCESS) {
		g_error ("PantheonGreeter.vala:515: Clutter could not be intiailized");
	}
	g_unix_signal_add_full (G_PRIORITY_DEFAULT, (gint) SIGTERM, ___lambda32__gsource_func, NULL, NULL);
	setlocale (LC_ALL, "");
	bind_textdomain_codeset ("pantheon-greeter", "UTF-8");
	textdomain ("pantheon-greeter");
...
gchar* get_defaults (const gchar* _default_) {
	...
	__catch7_g_error:
	{
		...
		g_warning ("PantheonGreeter.vala:559: %s", _tmp20_);
		_g_error_free0 (e);
	}
	__finally7:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
