...
static GObject * login_box_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	LoginOption* _tmp31_ = NULL;
	gboolean _tmp32_ = FALSE;
	gboolean _tmp33_ = FALSE;
	CredentialsArea* _tmp42_ = NULL;
	CredentialsArea* _tmp43_ = NULL;
	...
	if (_tmp8_ != NULL) {
		...
		_tmp10_ = path;
		_tmp11_ = gdk_pixbuf_new_from_file_at_size (_tmp10_, 100, 100, &_inner_error_);
		_tmp9_ = _tmp11_;
		...
		_tmp12_ = (GtkImage*) gtk_image_new_from_pixbuf (_tmp9_);
		...
		_tmp14_ = icon_theme;
		_tmp15_ = gtk_icon_theme_load_icon (_tmp14_, "avatar-default", 100, 0, &_inner_error_);
		_tmp13_ = _tmp15_;
		if (G_UNLIKELY (_inner_error_ != NULL)) {
			_g_object_unref0 (avatar);
			_g_free0 (path);
		...
		_tmp16_ = (GtkImage*) gtk_image_new_from_pixbuf (_tmp13_);
	...
	_tmp22_ = grid;
	_tmp23_ = self->priv->credentials_area;
	gtk_container_add ((GtkContainer*) _tmp22_, (GtkWidget*) _tmp23_);
	_tmp24_ = grid;
	gtk_widget_show_all ((GtkWidget*) _tmp24_);
	_tmp25_ = (GtkClutterActor*) gtk_clutter_actor_new ();
	g_object_ref_sink (_tmp25_);
	credentials_area_actor = _tmp25_;
	_tmp26_ = credentials_area_actor;
	clutter_actor_set_width ((ClutterActor*) _tmp26_, (gfloat) 288);
	_tmp27_ = credentials_area_actor;
	_tmp28_ = gtk_clutter_actor_get_widget (_tmp27_);
	_tmp29_ = grid;
	gtk_container_add (G_TYPE_CHECK_INSTANCE_CAST (_tmp28_, gtk_container_get_type (), GtkContainer), (GtkWidget*) _tmp29_);
	_tmp30_ = credentials_area_actor;
	clutter_actor_add_child ((ClutterActor*) self, (ClutterActor*) _tmp30_);
	_tmp31_ = self->priv->_user;
	_tmp32_ = login_option_get_logged_in (_tmp31_);
	_tmp33_ = _tmp32_;
	if (_tmp33_) {
		...
		_tmp34_ = (GtkImage*) gtk_image_new_from_icon_name ("selection-checked", GTK_ICON_SIZE_LARGE_TOOLBAR);
		g_object_ref_sink (_tmp34_);
		logged_in = _tmp34_;
		_tmp35_ = (GtkClutterActor*) gtk_clutter_actor_new ();
		g_object_ref_sink (_tmp35_);
		logged_in_actor = _tmp35_;
		_tmp36_ = logged_in_actor;
		_tmp37_ = logged_in_actor;
		clutter_actor_set_y ((ClutterActor*) _tmp37_, (gfloat) 75);
		clutter_actor_set_x ((ClutterActor*) _tmp36_, (gfloat) 75);
		_tmp38_ = logged_in_actor;
		_tmp39_ = gtk_clutter_actor_get_widget (_tmp38_);
		_tmp40_ = logged_in;
		gtk_container_add (G_TYPE_CHECK_INSTANCE_CAST (_tmp39_, gtk_container_get_type (), GtkContainer), (GtkWidget*) _tmp40_);
		_tmp41_ = logged_in_actor;
		clutter_actor_add_child ((ClutterActor*) self, (ClutterActor*) _tmp41_);
		_g_object_unref0 (logged_in_actor);
		_g_object_unref0 (logged_in);
	}
	_tmp42_ = self->priv->credentials_area;
	g_signal_connect_object (_tmp42_, "replied", (GCallback) __login_box___lambda15__credentials_area_replied, self, 0);
	_tmp43_ = self->priv->credentials_area;
	g_signal_connect_object (_tmp43_, "entered-login-name", (GCallback) __login_box___lambda16__credentials_area_entered_login_name, self, 0);
